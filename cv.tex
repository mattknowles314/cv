...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Open Health}{York, UK}
    \resumeItemListStart
        \resumeItem{Performed survival analysis in clinical trial data to help support health economic model devlelopment}
        \resumeItem{Gave talks about my work both internally and to clients}
        \resumeItem{Suppored the delivery of indirect treatment comparissons}
